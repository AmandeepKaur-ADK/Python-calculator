...
# lambda is a anonymous funciton a function without a name

# setting values in input field
def btn_click(item):
    global expression #global to modify scope of the variable
...
sub = Button(btns_frame, text='-', width=10, height=3, command=lambda: btn_click('-')).grid(row=2, column=3, padx=1, pady=1)
...
# Button fifth row
equals = Button(btns_frame, text='=', width=24, height=3, command=lambda: bt_equal()).grid(row=4, column=0, columnspan=2,padx=1, pady=1)
zero = Button(btns_frame, text='0', width=10, height=3, command=lambda: btn_click(0)).grid(row=4, column=2, padx=1, pady=1)
decimal = Button(btns_frame, text='.', width=10, height=3, command=lambda: btn_click('.')).grid(row=4, column=3,padx=1, pady=1)
